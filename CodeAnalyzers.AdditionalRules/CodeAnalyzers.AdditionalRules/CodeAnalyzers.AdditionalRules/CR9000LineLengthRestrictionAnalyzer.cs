...
//    /// <summary>
//    ///  Use this rule or CR9001 - only one of the two should be enabled 
//    ///  The line length restriction can by configured from stylecop.json file, if the file is missing no restriction will be added
//    ///  If the value of maximumLineLength property in stylecop.json file is 0 no restriction will be applied too
//    /// </summary>
